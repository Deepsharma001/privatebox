    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-xl-5 col-lg-6 col-md-9">
                <!-- about-img -->
                <div class="about-img">
                    <img src="{{ URL::asset('img/gallery/about1.png') }}" alt="">
...
<div class="latest-wrapper">
    <div class="container">
        <div class="latest-area latest-height  section-bg2" data-background="{{ URL::asset('/img/gallery/section_bg01.png') }}">
        ...
        <div class="row align-items-center">
                    ...
                    <div class="h1-testimonial-active">
                        ...
                        <div class="single-testimonial">
                            <div class="testimonial-caption">
                                <p>Brook presents your services with flexible, convenient and cdpose layouts. You can select your favorite layouts & elements for cular ts with unlimited ustomization possibilities. Pixel-perfect replica;ition of thei designers
            ...
            <div class="col-lg-5 col-md-11 col-sm-11">
                ...
                <div class="about-img2">
                    <img src="{{ URL::asset('/img/gallery/about2.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{ URL::asset('/img/gallery/home-blog1.png') }}" alt="">
                        </div>
                        <div class="blog-cap">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{ URL::asset('/img/gallery/home-blog2.png') }}" alt="">
                        </div>
                        <div class="blog-cap">
                            <h3><a href="blog_details.html">The purpose of lolght invera jgrlie.</a></h3>
                            <p>January 22, 2020</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{ URL::asset('/img/gallery/home-blog3.png') }}" alt="">
                        </div>
                        <div class="blog-cap">
                            <h3><a href="blog_details.html">The purpose of lolght invera jgrlie.</a></h3>
                            <p>January 22, 2020</p>
